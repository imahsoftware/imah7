class Users::PasswordsController < Devise::PasswordsController
  ...
  def create
    ...
    if user.present?
      ...
      Asearmail::SendmailServices.new.notificacionEmails(user.email, "Recuperación de Contraseña", "devise/mailer/reset_password_instructions.html.erb", nil, nil, user.reset_password_token, user.username)
