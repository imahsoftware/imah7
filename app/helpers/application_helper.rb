module ApplicationHelper
  ...
  def select_logo
    [
      ["ASEAR", "logo_inicio_asear.png"],
      ["MICROCINCO", "microcinco.jpg"],
      ["CONSTRUMATER", "construmater.jpg"],
      ["ASEAR TEMPORAL", "aseartemporal.jpg"],
      ["JULIAN GARCIA", "julian.jpg"],
      ["PROGESCOL", "progescol.jpg"]
    ]
  end
