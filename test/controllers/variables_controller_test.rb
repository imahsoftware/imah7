...
class VariablesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create variable" do
    assert_difference('Variable.count') do
      post variables_url, params: { variable: { campo: @variable.campo, nombre: @variable.nombre, segmento: @variable.segmento } }
    end
  ...
  test "should update variable" do
    patch variable_url(@variable), params: { variable: { campo: @variable.campo, nombre: @variable.nombre, segmento: @variable.segmento } }
