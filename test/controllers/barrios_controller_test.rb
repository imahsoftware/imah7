...
class BarriosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create barrio" do
    assert_difference('Barrio.count') do
      post barrios_url, params: { barrio: { comuna: @barrio.comuna, descripcion: @barrio.descripcion } }
    end
  ...
  test "should update barrio" do
    patch barrio_url(@barrio), params: { barrio: { comuna: @barrio.comuna, descripcion: @barrio.descripcion } }
