...
class PersonasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create persona" do
    assert_difference('Persona.count') do
      post personas_url, params: { persona: { identificacion: @persona.identificacion, nombre: @persona.nombre } }
    end
  ...
  test "should update persona" do
    patch persona_url(@persona), params: { persona: { identificacion: @persona.identificacion, nombre: @persona.nombre } }
