...
class TareasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tarea" do
    assert_difference('Tarea.count') do
      post tareas_url, params: { tarea: { estado: @tarea.estado, fecha: @tarea.fecha, objetivo: @tarea.objetivo, tema: @tarea.tema } }
    end
  ...
  test "should update tarea" do
    patch tarea_url(@tarea), params: { tarea: { estado: @tarea.estado, fecha: @tarea.fecha, objetivo: @tarea.objetivo, tema: @tarea.tema } }
