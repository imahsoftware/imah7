...
class EvaluacionesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create evaluacion" do
    assert_difference('Evaluacion.count') do
      post evaluaciones_url, params: { evaluacion: { estado: @evaluacion.estado, objetivo: @evaluacion.objetivo, tema: @evaluacion.tema, user_id: @evaluacion.user_id } }
    end
  ...
  test "should update evaluacion" do
    patch evaluacion_url(@evaluacion), params: { evaluacion: { estado: @evaluacion.estado, objetivo: @evaluacion.objetivo, tema: @evaluacion.tema, user_id: @evaluacion.user_id } }
